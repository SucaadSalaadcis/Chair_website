...
import sofa13 from '../assets/img/chairs/sofa13.png'
        ...
        <footer class="bg-white dark:bg-gray-900 mt-20">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">Suad</a>. All Rights Reserved.
                    </span>
